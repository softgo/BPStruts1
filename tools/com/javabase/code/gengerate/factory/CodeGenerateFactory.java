...
public class CodeGenerateFactory {
	...
	private static String connUrl = CodeResourceUtil.URL;
	...
	private static void initCreateBean(){
		if (createBean==null) {
			...
			createBean.setMysqlInfo(connUrl, userName, passWord);//设置数据库连接
		}
	}
	...
	public static void codeGenerate(String tableName, String codeName,
		...
		String sqlMapperPath = entityPackage +  "entity\\" + className+ "-Mapper.xml";
