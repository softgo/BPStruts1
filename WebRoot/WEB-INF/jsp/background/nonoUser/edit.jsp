   ...
   <div class="box">
     <div class="box_border">
       <div class="box_top" ><b class="pl15" >系统管理——>修改信息</b></div>
		...
		<form action="<%=request.getContextPath()%>/background/nonoUser/updateById.html" method="post" name="userForm" id="userForm">

			<input type="hidden" name="userCode" id="userCode" value="${objId}"><!-- 修改时候自动添加 -->
			...
			<table class="form_table pt15 pb15 list_table" width="100%" border="1" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="td_left" >
					<input class="input-text lh30" size="40" name="mobileNumber" id="mobileNumber" value="${object.mobileNumber}"></input>
				...
				<tr>
					...
					<td class="td_left" >
					<input class="input-text lh30" size="40" name="nonoCode" id="nonoCode" value="${object.nonoCode}"></input>
				...
				<tr>
					...
					<td class="td_left" >
					<input class="input-text lh30" size="40" name="certificateNumber" id="certificateNumber" value="${object.certificateNumber}"></input>
				...
				<tr>
					...
					<td class="td_left" >
					<input class="input-text lh30" size="40" name="userType" id="userType" value="${object.userType}"></input>
				...
				<tr>
					...
					<td class="td_left" >
					<input class="input-text lh30" size="40" name="isDelete" id="isDelete" value="${object.isDelete}"></input>
